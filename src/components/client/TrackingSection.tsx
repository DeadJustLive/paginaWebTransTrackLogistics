...
import { MapPin, Package, Truck, CheckCircle, Radio, Clock } from 'lucide-react';
...
export default function TrackingSection() {
    ...
    return (
        <section id="tracking" className="py-20 px-4 bg-gray-50">
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12">
                    <h1 className="mb-4 text-3xl font-bold">Seguimiento de Pedido</h1>
